...
const Navbar = () => {
  ...
  const navItems = (
    <>
      ...
      <li><a className="hover:text-primary" href='/course'>Course</a></li>
  ...
  return (
    <div className={`sticky top-0 z-50 transition duration-300 ${isScrolled ? 'bg-gray-300 shadow-lg' : 'bg-transparent'}`}>
      <div className="navbar container mx-auto">
        ...
        <div className="navbar-end space-x-4">
          <button className="btn btn-neutral" onClick={() => document.getElementById('my_modal_1').showModal()}>Login</button>
          <Login />
